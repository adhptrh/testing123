<div class="row row-xs">
  <div class="col-md-6">
    <div class="card">
      <div class="card-body">
        <?= form_open(base_url('setting/access_modifier/update')); ?>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <label>Nama</label>
              <?php $var = 'name'; ?>
              <input name="<?= $var; ?>" type="text" class="form-control <?= $has_error = (form_error($var)) ? 'is-invalid' : '' ?>" value="<?= $isi = (isset($old[$var])) ? $old[$var] : $data[$var]; ?>" >
      ...
      <div class="card-footer">
        <a href="<?= base_url('setting/access_modifier') ?>" class="btn btn-sm btn-danger" type="button" name="">Batal</a>
