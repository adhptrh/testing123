  ...
  <body>
    ...
    <header class="navbar navbar-header navbar-header-fixed">
      ...
      <div class="navbar-brand">
        <a href="<?=base_url('') ?>" class="df-logo">C<span>BT</span></a>
      </div><!-- navbar-brand -->
    ...
    <div class="content content-fixed content-auth-alt">
      <div class="container ht-100p tx-center">
        <div class="ht-100p d-flex flex-column align-items-center justify-content-center">
            <div class="mx-wd-600 mg-b-15"><img src="<?= base_url('/template/assets/img/2663517.png'); ?>" class="img-fluid" alt=""></div>
            <h1 class="tx-color-01 tx-24 tx-sm-32 tx-lg-36 mg-xl-b-5">Halaman Tidak Ditemukan (Error 404)</h1>
            <h5 class="tx-16 tx-sm-18 tx-lg-20 tx-normal mg-b-20">Oopps. Halaman yang Anda tuju saat ini belum tersedia.</h5>
    ...
    <footer class="footer">
      <div>
        <span>&copy; 2021 CBT v1.0.0. </span>
