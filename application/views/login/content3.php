        ...
        <div class="media align-items-stretch justify-content-center ht-100p pos-relative">
          ...
          <div class="sign-wrapper mg-lg-l-50 mg-xl-l-60">
            <div class="wd-100p">
              ...
              <div class="align-items-center alert alert-warning <?= $hide = ($this->session->flashdata('message')) ? '' : 'd-none' ?>">
                <i data-feather="alert-circle" class="mg-r-10"></i><?= $this->session->flashdata('message');  ?>
              </div>
              ...
              <div class="form-group">
                ...
                <input name="password" value="<?= $this->input->post('password'); ?>" type="password" class="form-control <?= $invalid = (form_error('password')) ? 'is-invalid' : ''  ?>" placeholder="Masukkan password">
                <div class="invalid-feedback">
                    <?= form_error('password') ?>
                </div>
              </div>
