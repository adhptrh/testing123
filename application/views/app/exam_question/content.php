      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-6 d-none d-md-block">
            <a href="<?= base_url('app/exam_question/create'); ?>" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 float-right"><i class="fa fa-plus"></i> Tambah</a>
          </div>
        </div>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?= base_url('app/exam_question/edit/' . $v['id']); ?>"><i class="fas fa-edit"></i> Edit</a>
                        <a class="dropdown-item hapus" href="#" data-href="<?= base_url('app/exam_question/delete/' . $v['id']); ?>"><i class="fas fa-trash"></i> Hapus</a>
                      </div>
                    </div>
                  </td>
                  <td><?= $v['period']?></td>
