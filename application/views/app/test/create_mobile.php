            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <div class="custom-control custom-radio mg-b-20">
                        <input data-value="opsi_a" type="radio" id="ftOpsiA" name="bOpsi" class="custom-control-input bOpsi">
                        <label class="custom-control-label tx-medium" for="ftOpsiA">A</label>
                        <div id="tOpsiA">Exam Option A</div>
                    </div>

                    <div class="custom-control custom-radio mg-b-20">
                        <input data-value="opsi_b" type="radio" id="ftOpsiB" name="bOpsi" class="custom-control-input bOpsi">
                        <label class="custom-control-label tx-medium" for="ftOpsiB">B</label>
                        <div id="tOpsiB">Exam Option B</div>
                    </div>

                    <div class="custom-control custom-radio mg-b-20">
                        <input data-value="opsi_c" type="radio" id="ftOpsiC" name="bOpsi" class="custom-control-input bOpsi">
                        <label class="custom-control-label tx-medium" for="ftOpsiC">C</label>
                        <div id="tOpsiC">Exam Option C</div>
                    </div>

                    <div class="custom-control custom-radio mg-b-20">
                        <input data-value="opsi_d" type="radio" id="ftOpsiD" name="bOpsi" class="custom-control-input bOpsi">
                    ...
                    <div id="fOpsiE" class="custom-control custom-radio mg-b-20">
                        <input data-value="opsi_e" type="radio" id="ftOpsiE" name="bOpsi" class="custom-control-input bOpsi">
